      ...
      <nav>
        <ul className="nav flex-column">
          <li className="nav-item">
            <NavLink className="nav-link" to="/ib" end onClick={onClose}>
          ...
          <li className="nav-item">
            <NavLink className="nav-link" to="/ib/withdrawal" onClick={onClose}>
          ...
          <li className="nav-item">
            <NavLink className="nav-link" to="/ib/profile" onClick={onClose}>
