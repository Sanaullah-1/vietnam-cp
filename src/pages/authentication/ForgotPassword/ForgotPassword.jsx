    ...
    <div className="forgot-password-wrapper">
      <div>
        <div className="text-center">
          ...
          <h5>{t('forgot_password.title')}</h5>
          <p style={{ maxWidth: "70%" }} className="text-center mx-auto mt-3">{t('forgot_password.sub-title')}</p>
        </div>
      </div>
      <div className="card-wrapper">
        ...
        />
        <div>
          <h5 className="text-primary fw-bold">{t('forgot_password.heading')}</h5>
          ...
          >
            {({ errors, handleChange }) => (
              <Form>
                <FormGroup
                  placeholder={t('forgot_password.form.labels.email')}
                  className="py-3"
                  name="email"
                  type="email"
                ...
                <AppButton
                  ...
                  loading={loading}
                >
                  {t('forgot_password.form.cta')}
                </AppButton>
              </Form>
            )}
          </Formik>
          <Trans i18nKey="forgot_password.remembred">
          ...
          {isSuccess && (
            <div className="alert alert-success mt-3 mb-0" role="alert">
              {t('forgot_password.form.success_message')}
            </div>
          )}
        </div>
      </div>
