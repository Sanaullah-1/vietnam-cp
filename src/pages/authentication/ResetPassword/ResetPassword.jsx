  ...
  if (!validToken)
    return (
      <p className="pt-5 text-center ">
        Token not valid <Link to="/forgot-password">Reset Again</Link>
      </p>
    );
    ...
    <div className="reset-password-wrapper">
      <div>
        <div className="text-center">
          ...
          <p style={{ maxWidth: "70%" }} className="text-center mx-auto mt-3">{t('reset_password.sub-title')}</p>
        </div>
      </div>
      <div className="card-wrapper">
        ...
        />
        <div>
          <h5 className="text-primary fw-bold">{t('reset_password.heading')}</h5>
          ...
          >
            {({ errors, handleChange }) => (
              <Form>
                <FormGroup
                  placeholder={t('reset_password.form.labels.new_password')}
                  className="py-3"
                  name="password"
                  type="password"
                ...
                />
                <FormGroup
                  placeholder={t('reset_password.form.labels.confirm_new_password')}
                  className="py-3"
                ...
                >
                  {t('reset_password.form.cta')}
                </AppButton>

                {error && (
                  <div className="alert alert-danger mt-3" role="alert">
                    {t('reset_password.form.error_message')}
                  </div>
                )}
                {resetSuccess && (
                  <div className="alert alert-success mt-3 mb-0" role="alert">
                    {t('reset_password.form.success_message')}
